        ...
        >
          ...
          <div className="mt-6 hidden justify-center gap-3 md:flex">
            <button
              type="button"
              onClick={scrollPrev}
              className="flex h-10 w-10 items-center justify-center rounded-full border border-gold/40 font-body text-base font-medium text-gold transition-all duration-200 hover:border-gold/65 hover:bg-gold/10 active:scale-95"
